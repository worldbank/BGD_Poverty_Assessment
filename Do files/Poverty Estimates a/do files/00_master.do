...
glo input        "$path\Do files\Data\2016\Raw data"
					
glo output       "$path\Do files\Poverty Estimates a\output"
glo temporary    "$path\Do files\Poverty Estimates a\output\temp"
cd               "$output"


*do files
glo do           "$path\Do files\Poverty Estimates a\do files"
