...
collapse (sum) edu_exp_2B=tot_exp (max) wgt post_factor ruc ,by(hhid)
...
collapse (sum) edu_exp_9d2=edu_exp_9d2 hlth_exp_9d2=hlth_exp_9d2,by(hhid)
sort hhid
...
collapse (sum) hlth_exp1_3A=hlth_exp1_3A hlth_exp2_3A=hlth_exp2_3A hlth_exp3_3A=hlth_exp3_3A,by(hhid) 
...
sort hhid
merge 1:1 hhid using "$temporary\t1"
tab _m
drop _m
sort hhid
merge 1:1 hhid using "$temporary\t2"
tab _m
drop _m
