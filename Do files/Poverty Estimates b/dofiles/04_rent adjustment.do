...
*****************************************************************************************************/
	...
	*Rent and imputed rent variables from Section 9, Part D
	...
	drop occ 
	reshape wide value, i(hhold) j(item)

	rename (value391 value392) (rent imprent)
	keep psu hhid hhold rent imprent
	...
	*Rural/urban variable
	...
	keep psu hhid hhold lnroom - rental ownership hhwgt ruc urbrural term qtr stratum16
	...
	*Merge household food and Non-food expenditure with dwelling characteristics
	merge 1:1 hhold using "$temporary/rent2"
	tab _m
	rename _merge merge1

	*Merge with rent and imputed rent
	merge 1:1 hhold using "$temporary/rent"
	tab _m
	drop _m
	...
	*keep  hhold stratum wgt2 rent imprent pr_rent hsvalhh fexp nfexp consexp consexp2 nfexp2
	*order hhold stratum wgt2 rent imprent pr_rent hsvalhh fexp nfexp consexp consexp2 nfexp2

	
    list hhold if rent==. & imprent==. & pr_rent==.
