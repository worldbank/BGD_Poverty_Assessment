...
*****************************************************************************************************/
	...
	*Group daily food items into 12 main categories 
	...
	merge m:1 hhold using "$temporary/ndaysall" 
	...
	* Weekly consumption
	...
	sort hhold
	merge hhold using "$temporary/temp1aall"
	tab _m
	drop _m
	*Convert weekly to monthly expenditure
	...
	merge 1:1 hhold using "$temporary/temp1ball"
	tab _m
	drop _m
	...
	*Merge with consumption expenditure database
	merge 1:1 hhold using "$temporary/temp0all"
	tab _merge
...
* ----------------------------------------------------------------------
	...
	*gen p = (value/quantity) 	
	...
	sort hhold
	merge hhold using "$temporary/temp0all"
	tab _merge
    keep if _merge==3
	drop _merge
...
*****************************************************************************************************/
	...
	use "$input2010/Mr Faiz/budgsh10_new.dta"
