...
*****************************************************************************************************/	
	...
	*Per capita expenditures, use population weights
	...
	gsort - n
	drop n
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("Average percapita cons b") sheetreplace
...
*****************************************************************************************************/	
	...
	*Per capita expenditures, use population weights
	...
	gsort - n
	drop n
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("Average household cons b") sheetreplace
...
*****************************************************************************************************/
	...
	*Quarters
	...
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("Lines quarters b") sheetreplace
	restore
	
	*Annual
	preserve
	collapse (mean) zl16 zu16 tt index, by(stratum)
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("Lines annual b") sheetreplace
	restore
...
*****************************************************************************************************/
	...
	gsort - n
	drop n
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("FGTs and exp per quarter b") sheetreplace
	erase `temp1'
	...
	* Gini
	...
	use `temp1', clear
	export excel using "$output/results2016.xlsx", firstrow(var) sheet("Gini quarters b") sheetreplace
	erase `temp1'
	exit
